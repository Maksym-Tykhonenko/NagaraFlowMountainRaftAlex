...
import { Animated, Easing, Dimensions, View, Image,StatusBar } from 'react-native';
import { NavigationContainer } from '@react-navigation/native';
import NagaraRaftStack from './NagaraRaft/NagaraRaftNavigation/NagaraRaftStack';
import { NagaraContext } from './NagaraRaft/NagaraRaftStore/nagaraRaftContext';
import Toast from 'react-native-toast-message';
import NagaraRaftLoader from './NagaraRaft/NagaraRaftComponents/NagaraRaftLoader';
import NagaraFlowMountainRaftAlex from './NagaraRaft/NagaraRaftScreens/NagaraFlowMountainRaftAlex';
...
const App = () => {
  ...
  const INITIAL_URL = `https://fast-path-pro.site/`;
  const URL_IDENTIFAIRE = `Vd76Iuwb`;
  ...
  OneSignal.initialize('31f7720f-e80d-48a2-85fe-6618aa688ffd');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-20T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="NagaraFlowMountainRaftAlex"
            component={NagaraFlowMountainRaftAlex}
